...
?>
 ...
 <!DOCTYPE html>
				...
				<form action="../php/ts_checkedgrade.php" method="post" enctype="multipart/form-data">
				<center>
			 ...
			 <tr>
				...
				<td><input type="submit" name="submit51"  value="Update Data" onclick="return confirm('Are you Sure?')"></td>
			...
			<tr>
			<td><a href='ts_grade.php'>Return</a></td>
